    ...
    def highlight_mandatory(self, style):
        ...
        return style \
            .apply(
                st.highlight_val,
                axis=None,
                subset=['Type', 'FC Number'],
                val='m',
                bg_color=bg_color,
                t_color='white',
                target_col='Type',
                other_cols=['FC Number'],
                theme=self.theme)
...
class FCDetails(FCBase):
    def __init__(self, **kw):
        ...
        self.cols = [
            a.UID, d.MineSite, d.Model, a.Unit, a.FCNumber, a.Complete, a.Scheduled, c.ManualClosed,
            a.Ignore, a.Classification, a.Subject, a.DateCompleteSMS, a.DateCompleteKA, b.ExpiryDate,
            a.SMR, a.Pictures, a.Notes]
...
class FCOpen(FCBase):
    ...
    def df_open_fc_unit(self, df=None, unit=None):
        ...
        return df \
            .pipe(lambda df: df[df.Unit == unit])[cols] \
            .assign(
...
class FCHistoryRolling(FCBase):
    def __init__(self, d_rng, minesite='FortHills', da=None):
        ...
        self.cols = [
            d.MineSite, a.Unit, a.FCNumber, a.Complete, c.ManualClosed, a.Classification, a.Subject,
            a.DateCompleteSMS, a.DateCompleteKA, a.MinDateComplete, a.ReleaseDate, a.ExpiryDate,
            b.hours, a.Ignore]
