...
cli.add_argument(
    ...
    const=True,
    default=None,
    help='Add default rows for current day.')
...
cli.add_argument(
    ...
    const=True,
    default=None,
    help='Export data to generic format.')
...
if __name__ == '__main__':
    ...
    if a.dlt:
        ...
        ex.add_defaults(em=em, d=a.date)
    elif a.sum:
        em.show_df_sum(n=a.sum)
    elif a.export:
        em.export_data(d_lower=dt.strptime(a.export, '%Y-%m-%d'))
    else:
